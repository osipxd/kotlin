...
public sealed class KaClassSymbol : KaClassLikeSymbol(), KaDeclarationContainerSymbol {
    ...
    /**
     * A list of the direct supertypes of the class. If the class has no explicit supertypes, the supertype will be [Any], or a special
     * supertype such as [Enum] for enum classes.
     *
