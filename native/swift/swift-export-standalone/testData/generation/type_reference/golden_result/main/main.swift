...
public var nullablePrim: Swift.Int32? {
    get {
        return __root___nullablePrim_get().flatMap { it in it.int32Value }
    }
    set {
        return __root___nullablePrim_set__TypesOfArguments__Swift_Int32_opt___(newValue.flatMap { it in NSNumber(value: it) } ?? .none)
    }
}
public var nullableRef: main.Class_without_package? {
    ...
    set {
        return __root___nullableRef_set__TypesOfArguments__main_Class_without_package_opt___(newValue.flatMap { it in it.__externalRCRef() } ?? 0)
    }
}
...
public func nullable_input_prim(
    ...
    return __root___nullable_input_prim__TypesOfArguments__Swift_Int32_opt___(i.flatMap { it in NSNumber(value: it) } ?? .none)
}
public func nullable_input_ref(
    i: main.Class_without_package?
) -> Swift.Void {
    return __root___nullable_input_ref__TypesOfArguments__main_Class_without_package_opt___(i.flatMap { it in it.__externalRCRef() } ?? 0)
}
public func nullable_output_prim() -> Swift.Int32? {
    return __root___nullable_output_prim().flatMap { it in it.int32Value }
}
