...
object ConeLombokAnnotations {
    ...
    abstract class BuilderBase(
        ...
        abstract class BuilderConeAnnotationAndConfigCompanion<T : BuilderBase>(annotationName: ClassId) :
    ...
    class Builder(
        ...
        setterPrefix: String?
    ) : BuilderBase(builderClassName, buildMethodName, builderMethodName, requiresToBuilder, visibility, setterPrefix) {
    ...
    class SuperBuilder(
        ...
        requiresToBuilder: Boolean,
        setterPrefix: String?
    ) : BuilderBase(builderClassName, buildMethodName, builderMethodName, requiresToBuilder, AccessLevel.PUBLIC, setterPrefix) {
