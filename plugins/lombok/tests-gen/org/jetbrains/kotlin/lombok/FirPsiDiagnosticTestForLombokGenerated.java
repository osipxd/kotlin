...
public class FirPsiDiagnosticTestForLombokGenerated extends AbstractFirPsiDiagnosticTestForLombok {
  ...
  @Nested
  @TestMetadata("plugins/lombok/testData/diagnostics/common")
  @TestDataPath("$PROJECT_ROOT")
  public class Common {
    @Test
    @TestMetadata("accessorsStripPrefixCombined.kt")
    public void testAccessorsStripPrefixCombined() {
      runTest("plugins/lombok/testData/diagnostics/common/accessorsStripPrefixCombined.kt");
    }

    @Test
    public void testAllFilesPresentInCommon() {
      KtTestUtil.assertAllTestsPresentByMetadataWithExcluded(this.getClass(), new File("plugins/lombok/testData/diagnostics/common"), Pattern.compile("^(.+)\\.kt$"), Pattern.compile("^(.+)\\.fir\\.kts?$"), true);
    }

    @Test
    @TestMetadata("annotationTypes.kt")
    public void testAnnotationTypes() {
      runTest("plugins/lombok/testData/diagnostics/common/annotationTypes.kt");
    }

    @Test
    @TestMetadata("builderAnnotationArguments.kt")
    public void testBuilderAnnotationArguments() {
      runTest("plugins/lombok/testData/diagnostics/common/builderAnnotationArguments.kt");
    }

    @Test
    @TestMetadata("builderConfig.kt")
    public void testBuilderConfig() {
      runTest("plugins/lombok/testData/diagnostics/common/builderConfig.kt");
    }

    @Test
    @TestMetadata("builderSingularNullability.kt")
    public void testBuilderSingularNullability() {
      runTest("plugins/lombok/testData/diagnostics/common/builderSingularNullability.kt");
    }

    @Test
    @TestMetadata("clashAccessors.kt")
    public void testClashAccessors() {
      runTest("plugins/lombok/testData/diagnostics/common/clashAccessors.kt");
    }

    @Test
    @TestMetadata("getters.kt")
    public void testGetters() {
      runTest("plugins/lombok/testData/diagnostics/common/getters.kt");
    }

    @Test
    @TestMetadata("gettersClassLevel.kt")
    public void testGettersClassLevel() {
      runTest("plugins/lombok/testData/diagnostics/common/gettersClassLevel.kt");
    }

    @Test
    @TestMetadata("setters.kt")
    public void testSetters() {
      runTest("plugins/lombok/testData/diagnostics/common/setters.kt");
    }

    @Test
    @TestMetadata("settersClassLevel.kt")
    public void testSettersClassLevel() {
      runTest("plugins/lombok/testData/diagnostics/common/settersClassLevel.kt");
    }
  }
}
